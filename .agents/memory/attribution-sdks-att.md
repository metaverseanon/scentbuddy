...
- Meta fbsdk-next on Expo: `clientToken` MUST be a literal string in `app.json` (static JSON, no env interpolation). It is embedded in the app binary — treat it as public config, not a secret. App ID is `1738053333886237`.
